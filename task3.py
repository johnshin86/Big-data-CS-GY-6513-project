...
#Overall 
df = getData("311_Service_Requests_for_2009.csv")
...
dates = [("2010-01-01",  "2010-12-31"),("2011-01-01",  "2011-12-31"),("2012-01-01",  "2012-12-31"),("2013-01-01",  "2013-12-31"),
		("2014-01-01",  "2014-12-31"),("2015-01-01",  "2015-12-31"),("2016-01-01",  "2016-12-31"),("2017-01-01",  "2017-12-31"),
...
#Month wise for 2017
date = [("2017-01-01",  "2017-01-31"),("2017-02-01",  "2017-02-31"),("2017-03-01",  "2017-03-31"),("2017-04-01",  "2017-04-31"),
...
for month in date:
	print("Processing for :{0}".format(date))
	monthDf = dateDf.where(col('Created Date').between(*date))
	...
	writeCompToCsv(compByLoc,"comptype_most_loc_"+date[0].split("-")[1]+".csv")
